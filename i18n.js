(function () {
  ...
  const russian = {
    ...
    'Words to practice': 'Слова для повторения',
    ...
    'Nicknames are case-insensitive. Keep your password safe; email recovery is unavailable.': 'Регистр букв в никнейме не важен. Сохраните пароль: восстановление по электронной почте недоступно.',
    'Nickname must be 2 to 24 characters.': 'Никнейм должен содержать от 2 до 24 символов.',
    'Use only letters, numbers, dots, underscores, or hyphens in your nickname.': 'Используйте в никнейме только буквы, цифры, точки, подчёркивания или дефисы.',
    'This nickname is already taken.': 'Этот никнейм уже занят.',
    'Nickname registration requires email confirmation to be disabled in Supabase Auth settings.': 'Для регистрации по никнейму отключите подтверждение электронной почты в настройках Supabase Auth.',
