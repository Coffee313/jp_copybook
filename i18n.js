(function () {
  ...
  const russian = {
    ...
    'Your support helps keep the copybook free and improve handwriting lessons.': 'Ваша поддержка помогает сохранять прописи бесплатными и улучшать уроки письма.',
    'Amount': 'Сумма',
    'Currency': 'Валюта',
    'Continue to secure payment': 'Перейти к безопасной оплате',
    'Donate': 'Поддержать',
    '♥ Donate': '♥ Поддержать',
    'Feedback': 'Обратная связь',
    'Creating a secure payment…': 'Создаём безопасный платёж…',
    'Donation service is not configured yet.': 'Сервис пожертвований пока не настроен.',
    'Could not create the payment. Please try again.': 'Не удалось создать платёж. Попробуйте ещё раз.',
    ...
    'Search by kanji, meaning, or note': 'Поиск по кандзи, значению или заметке',
    'No vocabulary matches your search.': 'По вашему запросу ничего не найдено.',
    'Export to Anki': 'Экспорт в Anki',
    'Meaning': 'Значение',
    'Hiragana reading': 'Чтение хираганой',
    'Pitch accent drop': 'Падение тона',
    'Optional: 0 is flat; 1 drops after the first mora; 2+ drops after that mora.': 'Необязательно: 0 — ровный тон; 1 — падение после первой моры; 2+ — падение после указанной моры.',
    'Pitch accent must be between 0 and the number of morae.': 'Номер падения тона должен быть от 0 до количества мор.',
